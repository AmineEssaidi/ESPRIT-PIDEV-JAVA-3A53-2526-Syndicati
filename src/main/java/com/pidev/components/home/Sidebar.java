...
public class Sidebar {
    ...
    public Sidebar() {
        ...
        addTopItem("Home", "🏠", () -> NavigationManager.getInstance().navigateTo("home"));
        ...
        addTopItem("Dashboard", "📊", () -> NavigationManager.getInstance().navigateTo("dashboard"));
    ...
    private Button makeButton(String icon, String label) {
        ...
        tLabel.setFont(Font.font(com.pidev.MainApplication.getInstance().getBoldFontFamily(), FontWeight.BOLD, 13));
