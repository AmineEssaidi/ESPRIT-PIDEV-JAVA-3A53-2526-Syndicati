package com.pidev.components.home;
...
public class HomeContent {
    ...
    private StackPane buildHero() {
        ...
        Text badgeText = new Text("⚡ Innovation Immobilière");
        ...
        Text desc = new Text(
            "L'excellence de la gestion de complexe résidentiel. Une plateforme tout-en-un pour la communication, la maintenance et l'engagement communautaire."
        );
    ...
    private VBox buildComplexHeader() {
        ...
        Text sub = new Text("Découvrez nos résidences de prestige et services haut de gamme.");
    ...
    private GridPane buildResidencesSection() {
        ...
        String[][] items = {
            {"Résidence Azure", "Les Berges du Lac", "NOUVEAU"},
    ...
    private VBox buildEventsSection() {
        ...
        section.getChildren().add(sectionHeader("Événements à Venir", "Rejoignez les activités de notre communauté vibrante.", "Tout voir"));
        ...
        String[][] events = {
            {"Assemblée Générale", "14 Mar 2026", "Club House", "Réunion annuelle pour discuter des décisions importantes de la copropriété.", "Réunion"},
            {"Journée de Nettoyage", "21 Mar 2026", "Jardin Central", "Mobilisation collective pour entretenir les espaces communs.", "Communauté"},
            {"Soirée Résidents", "29 Mar 2026", "Rooftop", "Moment convivial pour renforcer les liens entre voisins.", "Social"}
        };
    ...
    private VBox buildEventCard(String title, String date, String place, String desc, String badge) {
        ...
        Text more = new Text("Détails de l'événement →");
    ...
    private VBox buildCommunitySection() {
        ...
        section.setAlignment(Pos.TOP_CENTER);
        section.setMaxWidth(Double.MAX_VALUE);
        section.getChildren().add(sectionHeader("Focus Communauté", "Découvrez les dernières discussions de vos voisins.", "L'Espace Forum"));
        ...
        String[][] posts = {
            {"Amina Trabelsi", "12/03/2026", "Amélioration du jardin intérieur", "Que pensez-vous de l'ajout d'un nouvel espace détente près de l'entrée principale ?", "Idées"},
            {"Youssef Ben Ali", "11/03/2026", "Maintenance ascenseur bloc B", "Les travaux démarrent vendredi. Merci de signaler tout besoin spécifique avant demain.", "Maintenance"},
            {"Sarra Gharbi", "10/03/2026", "Organisation soirée ramadan", "Proposition d'une soirée conviviale dans l'espace commun ce week-end.", "Communauté"}
        };
    ...
    private VBox buildServicesSection() {
        ...
        section.setAlignment(Pos.TOP_CENTER);
        section.setMaxWidth(Double.MAX_VALUE);
        section.getChildren().add(centeredTitle("Nos Services", "Une suite complète de solutions pour votre copropriété."));
        ...
        String[][] services = {
            {"🏢", "Gestion Résidentielle", "Gérez vos résidences, appartements et résidents en toute simplicité."},
            {"🔧", "Maintenance & SAV", "Suivez les réclamations et planifiez les interventions techniques."},
            {"💬", "Communication", "Restez connecté avec vos voisins via notre forum et système de messagerie."},
            {"💳", "Paiements Sécurisés", "Réglez vos frais de syndic en ligne via nos solutions de paiement."}
        };
    ...
    private StackPane buildHelpCta() {
        ...
        Text desc = new Text("Des questions sur votre résidence ou besoin d'une assistance technique ? Notre équipe est à votre disposition.");
        ...
        HBox buttons = new HBox(18,
            ...
            buildSecondaryButton("Signaler un Problème")
        );
