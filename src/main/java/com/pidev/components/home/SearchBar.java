...
public class SearchBar {
    ...
    private void setup() {
        ...
        Text lens = new Text("🔍");
        lens.setFont(Font.font(com.pidev.MainApplication.getInstance().getBoldFontFamily(), FontWeight.BOLD, 16));
        lens.setFill(Color.web(theme.getIslandTextColor()));

        input.setPromptText("Search...");
        input.setFont(Font.font(com.pidev.MainApplication.getInstance().getLightFontFamily(), 14));
