...
import com.pidev.utils.database.ConnectionManager;
...
public class ConnectionStatusPill {
    ...
    public ConnectionStatusPill() {
        ...
        statusLabel.setFont(Font.font(com.pidev.MainApplication.getInstance().getBoldFontFamily(), FontWeight.BOLD, 11));
