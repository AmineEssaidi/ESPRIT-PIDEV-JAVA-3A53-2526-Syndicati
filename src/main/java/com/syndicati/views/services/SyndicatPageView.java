package com.syndicati.views.services;
...
public class SyndicatPageView implements ViewInterface {
    ...
    private TextField input(String prompt) {
        ...
        field.setStyle("-fx-background-color: " + inputBg() + "; -fx-text-fill: " + tm.getTextColor() + "; -fx-prompt-text-fill: " + textMuted() + "; -fx-background-radius: 16px; -fx-border-color: " + borderSoft() + "; -fx-border-radius: 16px; -fx-padding: 14 16 14 16;");
        return field;
    }
