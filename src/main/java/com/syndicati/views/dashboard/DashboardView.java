...
public class DashboardView implements ViewInterface {
    ...
    private String sidebarPillStyle() {
        String glassFill = theme().isDarkMode()
            ? "radial-gradient(focus-angle 22deg, focus-distance 24%, center 14% 10%, radius 130%, " + accentRgba(0.14) + " 0%, rgba(12,12,18,0.88) 64%, rgba(8,8,12,0.93) 100%), linear-gradient(to bottom right, rgba(30,30,40,0.40), rgba(18,18,24,0.52) 54%, rgba(10,10,14,0.66) 100%)"
    ...
    private void setupLayout() {
        ...
        root.setStyle(
            "-fx-background-color: radial-gradient(focus-angle 28deg, focus-distance 24%, center 14% 8%, radius 135%, " + accentRgba(0.10) + " 0%, rgba(6,6,10,0.98) 62%, rgba(2,2,4,0.99) 100%), " +
    ...
    private VBox createSidebar() {
        // Outer wrapper: transparent, no background Ã¢â‚¬â€œ only the three pills show
        VBox sb = new VBox(10);
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ TOP PILL: logo Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ NAV PILL: main items Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ BOTTOM PILL: back to app + sign out Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    private HBox createAdminHeader() {
        ...
        h.setStyle("-fx-background-color:rgba(0,0,0,0.98);-fx-border-color:rgba(255,255,255,0.14);-fx-border-width:0 0 1 0;");

        HBox searchBar = new HBox(8);
        searchBar.setAlignment(Pos.CENTER_LEFT);
        searchBar.setPadding(new Insets(7, 14, 7, 14));
        searchBar.setPrefWidth(280);
        searchBar.setStyle("-fx-background-color:rgba(255,255,255,0.08);-fx-background-radius:10px;-fx-border-color:rgba(255,255,255,0.16);-fx-border-width:1;-fx-border-radius:10px;");
        Text sch = new Text(" Search admin..."); sch.setFont(Font.font(lightFont(), FontWeight.NORMAL, 13)); sch.setFill(Color.web("rgba(255,255,255,0.60)"));
        ...
        Text chevron = t("v", boldFont(), FontWeight.BOLD, 13); chevron.setFill(Color.web("rgba(255,255,255,0.65)"));
    ...
    private VBox notificationRow(String title, String body, String time) {
        ...
        row.setOnMouseEntered(e -> row.setStyle("-fx-background-color:rgba(255,255,255,0.06);-fx-background-radius:14px;"));
