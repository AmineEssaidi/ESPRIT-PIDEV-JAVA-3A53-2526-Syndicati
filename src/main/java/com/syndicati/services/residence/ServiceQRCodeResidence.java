...
public class ServiceQRCodeResidence {
    private final BitMatrix bitMatrix;

    private BufferedImage qrImage;

    public ServiceQRCodeResidence(String data, BarcodeFormat format, int width, int height, int imageType) throws WriterException {
