...
public class DiscordWebhookService {
    ...
    public void sendAnnouncement(String title, java.io.File imageFile) {
        sendAnnouncement(title, "Announcement from Syndicati", "Syndicati Admin", imageFile == null ? null : imageFile.getName(), false);
    }
