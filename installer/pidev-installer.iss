; PiDev Dynamic Island - Inno Setup Installer Script
; This creates a professional Windows installer with progress bar

#define MyAppName "PiDev Dynamic Island"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "PiDev Team"
#define MyAppURL "https://github.com/pidev"
#define MyAppExeName "PiDev.bat"
...
OutputBaseFilename=PiDev-Setup-{#MyAppVersion}
...
; Launcher
Source: "..\dist\PiDev.bat"; DestDir: "{app}"; Flags: ignoreversion
